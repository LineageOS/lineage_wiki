...
<div class="theme-image-container" style="width: 50%;">
  <img src="{{ 'images/pages/flash_tools_tabs_light.png' | relative_url }}" class="only-light" width="100%">
  <img src="{{ 'images/pages/flash_tools_tabs_dark.png' | relative_url }}" class="only-dark" width="100%">
</div>
...
2. <img src="{{ 'images/pages/flash_tools_adb_system_light.png' | relative_url }}" class="only-light" width="50%">
   <img src="{{ 'images/pages/flash_tools_adb_system_dark.png' | relative_url }}" class="only-dark" width="50%">
...
5. <img src="{{ 'images/pages/flash_tools_adb_sideload_light.png' | relative_url }}" class="only-light" width="50%">
   <img src="{{ 'images/pages/flash_tools_adb_sideload_dark.png' | relative_url }}" class="only-dark" width="50%">
