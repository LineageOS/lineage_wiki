...
{% include alerts/warning.html content="This guide requires an advanced level of technical knowledge and skill to be completed successfully. If you are a beginner, you should seek assistance through IRC or on our Discord server!" %}
