...
|Version                   |Link                                                   |
|--------------------------|-------------------------------------------------------|
|LineageOS 24 (Android 17)|MindTheGapps ([ARM](https://github.com/MindTheGapps/17.0.0-arm/releases/latest), [ARM64](https://github.com/MindTheGapps/17.0.0-arm64/releases/latest))|
...
|Version                   |Link                                                   |
|--------------------------|-------------------------------------------------------|
|LineageOS 23 (Android 17)|MindTheGapps ([ARM](https://github.com/MindTheGapps/17.0.0-arm-ATV/releases/latest), [ARM64](https://github.com/MindTheGapps/17.0.0-arm64-ATV/releases/latest))|
