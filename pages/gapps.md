...
## OpenGApps Notice
If you opt to use OpenGApps, they offer a variety of sizes of packages that include and overwrite different apps. We only support up through the `nano` package, as linked above. If you use any larger package, we cannot guarantee support, as in many of these cases our included apps are overwritten in favor of GApps equivalents.
