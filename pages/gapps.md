...
{% include alerts/warning.html content="This only applies if Open GApps is listed as the GApps package for your Android version under Downloads. If Open GApps is not listed for your Android version, it is not recommended." %}
