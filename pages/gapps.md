...
We explicitely recommend *MindTheGapps* where available.

If you opt to use Open GApps, they offer a variety of sizes of packages that include and overwrite different apps.

We only recommend the following package sizes (or smaller):
