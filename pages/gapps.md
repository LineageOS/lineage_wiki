...
|Version                   |Link                                                   |
|--------------------------|-------------------------------------------------------|
|LineageOS 20 (Android 14)|MindTheGapps ([ARM](https://github.com/MindTheGapps/14.0.0-arm/releases/latest), [ARM64](https://github.com/MindTheGapps/14.0.0-arm64/releases/latest))|
...
|Version                   |Link                                                   |
|--------------------------|-------------------------------------------------------|
|LineageOS 20 (Android 14)|MindTheGapps ([ARM](https://github.com/MindTheGapps/14.0.0-arm-ATV/releases/latest), [ARM64](https://github.com/MindTheGapps/14.0.0-arm64-ATV/releases/latest))|
