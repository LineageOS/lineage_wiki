...
{% include note.html content="In case you are in the project's folder from where you made the changes, you can simply reference the project path with a dot: `repo upload .`" %}
