...
{% include note.html content="If you are still in the project's folder from where you made the changes, you can simply reference the project path with a dot: `repo upload .`" %}
