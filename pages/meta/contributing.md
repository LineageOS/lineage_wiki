...
You can now make changes in this folder from your favorite text editor. If you ever need to reset your folder to a known-good state, erasing your changes, just run `git reset --hard HEAD`
