...
If you already have a LineageOS source tree checked out, then this step is done for you. The wiki's git repository is present under `$SOURCETREE/lineage/wiki`
...
You can now make changes in this folder from your favourite text editor. If you ever need to reset your folder to a known-good state, erasing your changes, just run `git reset --hard HEAD`
...
**Docker requires a 64 bit OS. If you do not have a 64 bit OS, use a different method to preview your changes.**
