...
```
python /path/to/lineage-tree/scripts/update-payload-extractor/extract.py payload.bin -o ./
```
...
python /path/to/scripts/update-payload-extractor/extract.py payload.bin -o ./
```
