...
```
python /path/to/lineage-tree/scripts/update-payload-extractor/extract.py payload.bin --output_dir ./
```
...
```
sudo umount -r ~/android/system_dump/system/product/
sudo umount -r ~/android/system_dump/system/vendor/
