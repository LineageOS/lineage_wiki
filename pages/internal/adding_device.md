...
* `ships_multiple_versions`: Used if the device ships multiple LineageOS versions simultaneously. Should also have a device-specific note on the wiki page describing why. Remove if not used! 
