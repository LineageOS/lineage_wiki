...
* `format_on_upgrade_reason`: Used if the device needs to wiped on major LineageOS version upgrade to show a device-specific note on the wiki page describing why. Remove if not used!
