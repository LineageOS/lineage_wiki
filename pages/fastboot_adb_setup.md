...
### On macOS
1. Install [Homebrew](https://brew.sh), make sure to add `/opt/homebrew/bin` to `PATH` by following "Next steps".
2. Install `android-platform-tools` by running the following command: `brew install --cask android-platform-tools`.
