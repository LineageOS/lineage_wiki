...
## The list of supported models for my device doesn't contain a specific one I need. Can I still use it?
 - We try to have the list as complete as possible.
 - Not listed? Not supported. We will gladly update the list (or accept patches to do so) once you let us know about another model that works.
