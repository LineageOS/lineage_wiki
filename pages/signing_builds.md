...
{% include alerts/note.html content="For LineageOS versions older than 18.1 you will have to replace \"sign_target_files_apks\" with \"./build/tools/releasetools/sign_target_files_apks\" in commands below." %}
