...
From Android 12, you may also sign APEXes with your own keys.
...
it's finished, you just need to sign all the APKs and possibly APEXes:
...
Signing for LineageOS versions older than 19.1:
```
croot
...
```
Signing for LineageOS versions from 19.1:
```
croot
sign_target_files_apks -o -d ~/.android-certs \
