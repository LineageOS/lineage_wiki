...
4. Boot the virtual machine into recovery mode, Do Factory reset.
...
3. Boot the virtual machine into recovery mode, Do Factory reset.

4. Enter fastbootd mode by selecting `Advanced` > `Enter fastboot`.

5. Delete unused logical partitions, and lash the GSI image, using `fastboot`:
