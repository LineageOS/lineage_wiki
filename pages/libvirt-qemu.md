...
{% include alerts/tip.html content="If your goal is to develop and debug Android applications, then using [Emulator/AVD]({{ "/emulator" | relative_url }}) is the better option." %}
