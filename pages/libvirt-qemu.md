...
With Mouse input, you'll have to click on the display area to grab the mouse cursor into the virtual machine, and press `Ctrl+Alt` to release the mouse cursor from the virtual machine. It works fine in recovery mode too.
