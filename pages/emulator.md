...
{% include alerts/note.html content="For LineageOS 19.1 the emulator targets lack support for arm/arm64, and are therefore only buildable for the `x86` and `x86_64` architectures." %}
