...
| Updater         | System Updater App | [Gerrit](https://review.lineageos.org/admin/repos/LineageOS/android_packages_apps_Updater)         | [GitHub](https://github.com/LineageOS/android_packages_apps_Updater)         |
{: .table }
...
1) Add reviewers:
  - Add [Trusted Reviewers]({{ "contributors.html#trusted-reviewers" | relative_url }}) or [Committers]({{ "contributors.html#committers" | relative_url }}). You can look at the commit history of the app you are working on, in order to see who would be the right person to add.
