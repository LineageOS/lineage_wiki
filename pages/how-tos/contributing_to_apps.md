...
{%- capture content %}If you are looking for things to work on, check out the list of [platform issues](https://github.com/LineageOS/issues/issues?q=is%3Aissue%20state%3Aopen%20label%3Aplatform), and look for an issue related to one of the apps listed here.{% endcapture %}
