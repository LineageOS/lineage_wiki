...
When editing current strings, be sure to only edit the main strings file in `values/strings`. There is no need to update, add or delete any of the strings in the translations, even if you only changed the string name. All of this is taken care of by our regular translation imports.
