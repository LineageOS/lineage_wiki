...
searchInput.on('input', function(e) {
    ...
    // we do this here in case we update jekyll-search any time - useless for now
    supressUpDownPropagation(e);
});

searchInput.on('keyup', function(e) {
    // this supresses the propagation of the up and down arrows to not retrigger a search
    supressUpDownPropagation(e);
});
