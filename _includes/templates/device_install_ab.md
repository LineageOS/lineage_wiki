...
10. _(Optional)_: To install any additional packages, you'll need to first reboot to recovery (as you can't flash to the inactive slot), then follow the same instructions as above.
