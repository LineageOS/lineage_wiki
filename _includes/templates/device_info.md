...
- [Update from an older build of the same version]({{ "devices/" | append: device.codename | append: "/update" | relative_url }})
{% assign versions_count = device.versions|size -%}
{%- if versions_count > 1 -%}
- [Upgrade to a higher version]({{ "devices/" | append: device.codename | append: "/upgrade" | relative_url }})
{%- endif -%}
