...
### Installation
[How to install LineageOS on the {{ site.data.devices[page.device].vendor }} {{ site.data.devices[page.device].name }}](install_on_{{site.data.devices[page.device].codename}}.html)
