...
- [Build for yourself]({{ "devices/" | append: device.codename | append: "/install" | relative_url }})
- [Update from an older build]({{ "devices/" | append: device.codename | append: "/install" | relative_url }})
{% assign versions_count = device.versions|size -%}
{%- if versions_count > 1 -%}
- [Upgrade from an older version]({{ "devices/" | append: device.codename | append: "/install" | relative_url }})
{%- endif -%}
