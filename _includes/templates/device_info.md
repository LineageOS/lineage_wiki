...
- [Update from an older build]({{ "devices/" | append: device.codename | append: "/update" | relative_url }})
{% assign versions_count = device.versions|size -%}
{%- if versions_count > 1 -%}
- [Upgrade from an older version]({{ "devices/" | append: device.codename | append: "/upgrade" | relative_url }})
{%- endif -%}
