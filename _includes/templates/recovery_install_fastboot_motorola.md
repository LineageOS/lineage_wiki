...
{% include alerts/note.html content="Motorola devices have a waiting period before you can enable `OEM Unlock` option in the developer options. It can vary between three days to three weeks." %}
