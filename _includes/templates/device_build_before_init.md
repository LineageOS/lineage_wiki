...
* A relatively recent x86_64 computer:
  * Linux, macOS, or Windows - these instructions are usually tested on the latest version Ubuntu, but the LTS version is highly recommended.
...
While for Ubuntu versions older than 23.10 (mantic), install also:
