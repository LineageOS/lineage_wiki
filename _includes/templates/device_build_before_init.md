...
libvirt QEMU targets uses Mesa that is based on upstream repository since LineageOS 22.0. To build LineageOS 22.0 and above for libvirt QEMU targets, you'll also need:
