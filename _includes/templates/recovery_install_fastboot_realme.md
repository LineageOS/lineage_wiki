...
5. Reboot the device manually, if it doesn't get rebooted automatically. The device should have been unlocked by now.
6. Since the device gets reset completely, you need to re-enable USB debugging to continue.
