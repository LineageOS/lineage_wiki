...
3. Now, rename the downloaded image to "recovery.img", open a Command Prompt and TAR the file by running `tar -cvzf %USERPROFILE%\Downloads\recovery.tar %USERPROFILE%\Downloads\recovery.img`.
{% endif %}
{% endif %}
