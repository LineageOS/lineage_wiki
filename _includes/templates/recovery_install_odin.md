...
3. Now, rename the downloaded image to "recovery.img", open a PowerShell and TAR the file by running `tar -cvzf recovery.tar C:\Users\%USERNAME%\Downloads/recovery.img`.
{% endif %}
{% endif %}
