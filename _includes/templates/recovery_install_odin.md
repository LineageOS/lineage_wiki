...
11. A blue transfer bar will appear on the device showing the recovery image being flashed.
    {% include alerts/tip.html content="Note that the phone will continue to display \"Downloading... Do not turn off target!!\" even after the process is complete. When the status message in the top left on of the devices's display says reports the process is complete, you can proceed." %}
