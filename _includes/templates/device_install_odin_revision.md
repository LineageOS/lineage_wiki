...
{%- endfor %}
{%- endif %}
If you don't know your console revision, reboot into bootloader. Orientation of the large green "START" text tells you: left-facing = `odin_m0`, right-facing = `odin_m2`.
