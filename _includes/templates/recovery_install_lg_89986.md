...
{% endif %}
{% endif %}
2. Follow steps 1-14 from [this guide](https://android.gadgethacks.com/how-to/root-your-t-mobile-lg-v20-using-dirty-cow-0175329/) but instead of using the guide's TWRP image on step 14, use the file from above.