...
6. Now you can install twrp installer zip (if available) to make twrp persistent else continue to flash lineage. 

7. If you have flashed twrp installer zip you can boot into twrp from next boot using:
