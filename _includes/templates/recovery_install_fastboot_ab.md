...
{% include alerts/note.html content="This is only temporary because recovery is part of the boot image and will be replaced once you install LineageOS. It is not optional, though!" %}
