...
```
    ...
    {% include alerts/tip.html content="If you don't see your device in the output, try a USB 2.0 port, or USB 2.0 Hub, as opposed to USB 3.0+ if available, as `fastboot` support for USB 3.0+ can be flaky." %}
