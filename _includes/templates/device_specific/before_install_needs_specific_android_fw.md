...
firmware version mentioned below. If your current installation is newer or older than the mentioned, please upgrade or downgrade to the required version before proceeding
{%- else %}
