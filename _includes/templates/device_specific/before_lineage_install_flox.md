...
3. From your Terminal/PowerShell, run `adb sideload flo-deb_clamor_repartition.zip`.
...
4. Now run `adb shell` from your Terminal/PowerShell, and run the following commands within it:
    - modify
5. Click,"Factory Reset", then "Format system partition", "Format cache partition" and "Format data/factory reset".