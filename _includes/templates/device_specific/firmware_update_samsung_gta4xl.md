...
3. Run the following command:
  ```
samloader flash --partition CM cm.bin --partition KEYSTORAGE keystorage.bin --partition RADIO modem.bin --partition CP_DEBUG modem_debug.bin --partition BOOTLOADER sboot.bin --partition UH uh.bin --partition UP_PARAM up_param.bin
  ```
