...
1. Download the latest **Android {{ device.before_install.version }}** full stock ROM update using [nothing_archive](https://github.com/spike0en/nothing_archive.git)
{%- else -%}
1. Download the latest full stock ROM update using [nothing_archive](https://github.com/spike0en/nothing_archive.git)
{%- endif %}
