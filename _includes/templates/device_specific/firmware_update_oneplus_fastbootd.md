...
{% include alerts/warning.html content="Before flashing firmware, please make sure that the [installation guide]({{ "devices/" | append: device.codename | append: "/install" | relative_url }}) does not require a specific firmware version." %}
