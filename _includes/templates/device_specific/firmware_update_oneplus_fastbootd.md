{% include alerts/warning.html content="These instructions only apply to the retail devices. If you happen to have a carrier branded variant you will have to download firmware files from elsewhere." %}
