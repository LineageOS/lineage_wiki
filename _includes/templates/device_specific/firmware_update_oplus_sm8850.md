...
fastboot flash --slot=all hyp_ac_config hyp_ac_config.img
...
fastboot flash --slot=all secretkeeper secretkeeper.img
...
fastboot flash --slot=all soccp soccp.img
fastboot flash --slot=all splash splash.img
fastboot flash --slot=all spuservice spuservice.img
fastboot flash --slot=all tme_config tme_config.img
fastboot flash --slot=all tme_fw tme_fw.img
fastboot flash --slot=all tme_seq_patch tme_seq_patch.img
fastboot flash --slot=all tz tz.img
fastboot flash --slot=all tz_ac_config tz_ac_config.img
fastboot flash --slot=all tz_qti_config tz_qti_config.img
fastboot flash --slot=all uefi uefi.img
fastboot flash --slot=all uefisecapp uefisecapp.img
fastboot flash --slot=all xbl xbl.img
fastboot flash --slot=all xbl_ac_config xbl_ac_config.img
