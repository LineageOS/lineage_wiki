...
<div id="unblur" style="display: none;">
  To continue, read the button and click it, when you met the conditions:<br/>
  <button onclick="toggleBlur()" class="btn btn-primary">I have read, understood and performed all of the above</button>
</div>
