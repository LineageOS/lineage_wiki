...
3. _(Optional, but recommended)_: Select the **Backup** button to create a backup.
4. Select **Wipe** and then **Format Data**. Continue with the formatting process. This will remove encryption and also delete all files on internal storage.
