...
5. Boot your device with the stock OS at least once and check every functionality.
	...
	{%- endunless %}
	{%- endif %}
5. If you haven't done so already, back up all your personal data from your device. Installing lineage will require you to delete all data in a later step.
...
{%- if device.before_install.instructions == "needs_specific_android_fw" or device.before_install.instructions =="us996"%}
...
- The current firmware version can usually be found in the Settings/About Phone section. 
