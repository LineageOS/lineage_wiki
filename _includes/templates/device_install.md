...
9. Once all installations are finished, run 'adb reboot'.
    ...
    {% include alerts/warning.html content="Depending on your recovery, it might prompt you for additional installation of apps and services. We strongly advise you to not install these along with a LineageOS build as it might prevent boot or access your data." %}
