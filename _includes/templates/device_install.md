...
4. If you aren't already in recovery, boot into recovery: {{ site.data.devices[page.device].recovery_boot }}
...
10. _Optional_: install any additional packages using the same method
