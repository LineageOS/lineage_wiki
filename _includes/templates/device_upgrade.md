...
{%- capture recovery_update %}In some cases a newer LineageOS version may not install due to outdated recovery.
Follow your [device's]({{ "devices/" | append: device.codename | append: "/install" | relative_url }}) installation guide to see how you can update your recovery image.{% endcapture %}
