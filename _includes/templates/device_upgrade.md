...
{% else %}
9. Once you have installed everything successfully, click back, then "Reboot system now".
{% else %}
9. _(Optional)_: Root your device by installing [LineageOS' AddonSU](https://download.lineageos.org/extras), (use the `{{ userspace_architecture }}` package) or by using any other method you prefer.
10. Once you have installed everything successfully, click back, then "Reboot system now".
{% endif %}
{% endif %}
