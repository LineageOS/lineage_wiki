...
{% include alerts/tip.html content="You may also be able to build using WSL (Windows Subsystem for Linux), although the exact steps may vary. If you are interested in building using WSL, you can find some guides online with instructions on how to set up WSL and the steps to build with WSL. " %}
