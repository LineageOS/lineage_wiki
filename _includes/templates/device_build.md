...
{% include note.html content="This step requires to have a device already running the latest LineageOS for the device you wish to build for. If you don't have access to such device, refer to [Extracting proprietary blobs from zip installers](extracting_blobs_from_zips.html)" %}
