...
{% include alerts/note.html content="We only support using [bash](https://www.gnu.org/software/bash/) when building LineageOS, since other shells are incompatible with Android's build scripts." %}
