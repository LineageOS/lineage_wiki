...
{% include note.html content="This step requires to have a device already running the latest LineageOS for the device you wish to build for. If you don't have access to such device, refer to [Extracting Proprietary Blobs from Installable zips](extracting_proprietary_blobs_from_installable_zips.html)" %}
