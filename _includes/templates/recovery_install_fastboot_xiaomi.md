...
3. At the same time, link the device to your Mi account in Settings -> Additional settings -> Developer options -> Mi Unlock status. This will trigger a countdown of 360h, a waiting period before a device can be unlocked. Note that you will be prevented from unlocking your device for 3 days if you don't link it beforehand.
