...
3. While waiting, link the device to your account in Settings -> Additional settings -> Developer options -> Mi Unlock status. You will be prevented from unlocking your device for 3 days if you don't link it beforehand.
