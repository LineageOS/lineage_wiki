...
{% include alerts/important.html content="It is required to have the latest official MIUI dev package installed on the device, before installing a custom recovery." %}
{% endif %}
