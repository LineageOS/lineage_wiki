...
1. Download [Lineage Recovery](https://download.lineageos.org/devices/{{ custom_recovery_codename }}). Simply download the latest recovery file, named `{{ custom_recovery_codename }}.img`.
{%- else %}
{%- assign is_lineage_recovery = true %}
