...
3. Power off the your device and connect the USB adapter to the computer (but not to the device, yet).
...
6. On the computer, open a command prompt (on Windows) or terminal (on Linux or macOS) window in the directory the recovery image is located, and type:
