...
2. Download and install the appropriate version of the Heimdall suite for your machine's OS
    * [Windows](https://undocumented.software/heimdall/Heimdall-Windows-master-012220.zip): Extract the Heimdall suite zip and take note of the new directory containing `heimdall.exe`. You can verify Heimdall is functioning by opening a Command Prompt or PowerShell in that directory and running `heimdall version`.
    ...
    * [Linux](https://undocumented.software/heimdall/Heimdall-linux-master-012220.zip): Extract the Heimdall suite zip and take note of the new directory containing `heimdall`. Now copy `heimdall` into a directory in $PATH, a common one on most distros will be /usr/local/bin. For example `cp heimdall /usr/local/bin`. You can verify Heimdall is functioning by opening a Terminal and running `heimdall version`.
    * [macOS](https://undocumented.software/heimdall/Heimdall-macOS-master-012220.dmg): Mount the Heimdall suite DMG. Now drag `heimdall` down into the `/usr/local/bin` symlink provided in the DMG. You can verify Heimdall is functioning by opening a Terminal and running `heimdall version`.
