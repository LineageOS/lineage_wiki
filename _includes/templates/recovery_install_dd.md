...
{% include note.html content="Accept the factory reset prompt using your hardware buttons. If you have done everything correctly, this will not actually reset your device but instead will install your custom recovery." %}
{% endif %}
