...
{% include alerts/important.html content="This step only applies to Chinese Realme devices **purchased with China Stock ROM pre-installed**." %}
...
* For the GT series, 300 slots will be released for the first time one month after the launch event. Starting the following month **until maintenance ends**, 200 slots will be released on the 1st of each month (Chinese time).

* For other series, 200 slots will be released for the first time one month after the launch event. Starting the following month **until maintenance ends**, 200 slots will be released on the 1st of each month (Chinese time).

Please note that once you have been granted unlock access, you **must** unlock your device following the instructions in the next step within 7 days. Each application is valid for a single device only and cannot be transferred to any other device. If your application is declined for any reason, you can resubmit until it is accepted.

LineageOS is not affiliated with Realme, nor will you find support with filling applications in our community. Only proceed once you have followed all required steps to unlock the bootloader.
...
3. Download and install the bootloader unlock app from [here](https://r11.realme.net/CN/thread-attachment/888043131025080903.zip).
4. Open the app and sign in with your HeyTap account.
5. Tap "Start Application", carefully read the disclaimer, and check the box to agree.
6. Tap "Submit Application" and return to the application screen. You can use "Query Review Status" to check if your application has been approved.
7. Once approved, tap "Start Deep Testing". Your device will reboot into fastboot mode.
