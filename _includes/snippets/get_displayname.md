...
{%- if testValue != "0" or include.device.vendor == "OnePlus" or include.device.vendor == "Realme" or include.device.vendor == "Retroid Pocket" %}{% assign display_name = include.device.vendor | append: ' ' | append: include.device.name %}
